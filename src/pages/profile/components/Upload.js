...
const mapStateToProps=(state)=>{
    return {
        previewVisible:state.getIn(['profile','previewVisible']),
        previewImage:state.getIn(['profile','previewImage']),
        file:state.getIn(['profile','file'])
    }
}
...
const mapDispatchToProps = (dispatch)=>{
    return {
        handleCancel() {
            console.log('删除预览')
            dispatch(actionCreators.handleProfilePreviewCancel())
        },
        handlePreview(){
            console.log('处理预览');
            dispatch(actionCreators.handleProfilePreview())
        },
        handleChange(file){
            console.log(file)
            console.log("文件有变化了")
